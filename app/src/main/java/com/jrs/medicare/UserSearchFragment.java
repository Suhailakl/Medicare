...
public class UserSearchFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchItem=menu.findItem(R.id.action_user_search);
        SearchManager searchManager= (SearchManager) getActivity().getSystemService(Context.SEARCH_SERVICE);
        search= (SearchView) menu.findItem(R.id.action_user_search).getActionView();
                    ...
                    protected void populateViewHolder(DoctokAdminHolder viewHolder, final Doc model, int position) {
                        ...
                        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                BookDocFragment bk = new BookDocFragment();
                                Bundle b = new Bundle();
                                b.putString("uid", model.getUid());
                                bk.setArguments(b);
                                ft.replace(R.id.content_user_home, bk);
